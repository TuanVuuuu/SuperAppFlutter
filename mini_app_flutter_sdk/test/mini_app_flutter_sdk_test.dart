...
void main() {
  final MiniAppFlutterSdkPlatform initialPlatform = MiniAppFlutterSdkPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockMiniAppFlutterSdkPlatform fakePlatform = MockMiniAppFlutterSdkPlatform();
